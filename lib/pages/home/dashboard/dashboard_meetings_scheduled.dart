...
class DashboardMeetingsScheduled extends StatelessWidget {
      ...
      builder: (final _, final state) => Column(
        children: [
          ...
          DashboardSectionTitle(
            translate(context, TranslationKeys.Dashboard_Meetings_Scheduled)!,
          ...
          StaticGrid(
            ...
            spacing: 28,
            runSpacing: 28,
            children: state.api.data!.acceptedMeetings
